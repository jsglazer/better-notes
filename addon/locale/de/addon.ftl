...
sync-autoLink-selectFolder-title = enhanced-notes – Verknüpfte Notiz automatisch synchronisieren
...
userGuide-start-title = Willkommen bei enhanced-notes!
userGuide-start-desc = enhanced-notes ist ein leistungsstarkes Tool zum Erstellen von Notizen, mit dem Du Deine Gedanken und Ideen beim Lesen von Dokumenten organisieren kannst. Dieser Leitfaden hilft Dir beim Einstieg in enhanced-notes und zeigt Dir, wie Du die Funktionen optimal nutzen kannst.
...
userGuide-openNote-desc = Du kannst mit Doppelklick eine Notiz im enhanced-notes Workspace-Tab öffnen.
...
userGuide-finish-desc = Viel Spaß beim Notieren mit enhanced-notes!
