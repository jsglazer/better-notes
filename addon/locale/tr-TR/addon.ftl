...
sync-autoLink-selectFolder-title = enhanced-notes - Bağlı Notu Otomatik Eşitle
...
userGuide-start-title = enhanced-notes'a hoş geldiniz!
userGuide-start-desc = enhanced-notes düşüncelerinizi ve tasarılarınızı düzenlemenize yardımcı olan güçlü bir not alma aracıdır. Kullanımı kolay ve yalın biçimde tasarlanmış olsa da karmaşık not alma işlerini görebilecek kadar da esnektir. Bu rehber size enhanced-notes'u kullanmaya başlamanıza ve ileri düzey işlevleri verimli kullanmanıza yardımcı olacaktır.
...
userGuide-openNote-desc = Herhangi bir nota çift tıklayarak notu yeni bir enhanced-notes çalışma alanı sekmesinde açabilirsiniz.
...
userGuide-finish-desc = enhanced-notes ile not alma yolculuğunuzun tadını çıkartın!
